...
\title{
	OS-Level Task-Based Engine for Lightweight Manycore Processors
}
...
\maketitle
	...
	\input{text/0-abstract.tex}
	\input{text/1-introduction.tex}
	\input{text/2-related-works.tex}
	\input{text/3-problem.tex}
	\input{text/4-paralelism.tex}
	\input{text/5-platform.tex}
	\input{text/6-results.tex}
	\input{text/7-conclusions.tex}
