\section{Virtualization}
	...
	\begin{frame}[fragile]{Virtual Machines (VM)}
		...
		\addfig[][width=.45\linewidth]{vm.pdf}
	\end{frame}
	...
	\begin{frame}[fragile]{Migration of VMs}
		...
		\only<1>{
			\begin{itemize}
				...
				\begin{itemize}
					\setlength \itemsep{0.3em}
					\item Hypervisor allocated memory 
					\item Guest OS  allocated memory 
					\item Application requested memory 
				\end{itemize}
				\item Disk content
				\begin{itemize}
					\setlength \itemsep{0.3em}
					\item Hypervisor allocated blocks 
					\item Guest OS used blocks
					\item Application used blocks
				\end{itemize}
			\end{itemize}
		}
		\only<2>{
	...
	\begin{frame}[fragile]{Containers}
		...
		\addfig[][width=.45\linewidth]{container.pdf}
	\end{frame}
